//Get all the Selectors by Id and Class:
...
const createSlider = () => {
  ...
  if (duration >= 1000) {
    ...
    let errorTimeMsg = document.createElement('div');
    errorTimeMsg.innerHTML = `<p class="bg-warning text-center font-weight-bold text-danger py-4 h3">Duration Time should not be negative, It must be greater than or equal to 1000ms</P>`;
    sliderContainer.appendChild(errorTimeMsg);
  }
};
